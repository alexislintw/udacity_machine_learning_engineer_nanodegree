...
class LearningAgent(Agent):
	...
	#self.epsilon = self.epsilon - 0.05
        ...
        self.total_trials += 1
        self.epsilon = math.pow(0.95,self.total_trials)
    ...
    def choose_action(self, state):
        ...
        if self.learning:
            if  self.epsilon*100 > random.randint(0,100):
                action = self.valid_actions[random.choice()]
            else:
...
def run():
    ...
    sim.run(tolerance=0.005,n_test=25)
    #0.005
